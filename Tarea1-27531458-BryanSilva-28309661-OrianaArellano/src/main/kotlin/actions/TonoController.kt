    ...
    fun negativeImage(imageMatrix: ImageMatrix): ImageMatrix {
        ...
        for (y in 0 until height) {
            for (x in 0 until width) {
                imageMatrix.pixels[y][x].r = 225 - imageMatrix.pixels[y][x].r
                imageMatrix.pixels[y][x].g = 225 - imageMatrix.pixels[y][x].g
                imageMatrix.pixels[y][x].b = 225 - imageMatrix.pixels[y][x].b
            }
        }
        return imageMatrix
    }
